...
Write-Host ''
Write-Host 'Paste a NEW GitHub runner registration token.'
Write-Host 'Get it from:'
Write-Host '  https://github.com/eugeniorossi2025-sudo/TradingDashboard-2a/settings/actions/runners/new?runnerOs=windows'
Write-Host ''
$runnerToken = Read-Host 'Registration token'
...
Write-Host '     New-Website -Name decisore -Port 80 -PhysicalPath C:\inetpub\decisore\current -ApplicationPool decisore'
Write-Host '  3. Create shared config folders:'
...
Write-Host '  4. Copy production appsettings.Production.json to:'
Write-Host '     C:\inetpub\decisore\shared\appsettings.Production.json'
Write-Host '  5. Trigger first deploy from GitHub Actions web UI.'
