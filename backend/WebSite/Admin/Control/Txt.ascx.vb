Namespace Controls
    ...
    Partial Class Control_Txt
        ...
        Protected Sub TxtVal_TextChanged(sender As Object, e As EventArgs) Handles TxtVal.TextChanged
