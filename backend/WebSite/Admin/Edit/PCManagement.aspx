<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MasterFirst.master" AutoEventWireup="false"
    CodeFile="PCManagement.aspx.vb" Inherits="PCManagement" Trace="false" %>
        ...
        <ContentTemplate>
            <div class="tool-top-container">
                ...
                <div class="tool-top-link">
                    ...
                    &nbsp;&nbsp;  
                    <asp:LinkButton ID="LnkDeleteJSON" runat="server" class="btn btn-primary" CommandName="DeleteJSON"  OnClientClick="javascript:return confirm('Delete Json and Graph Margin?')">
                         Delete JSON and Graph Margin
                    </asp:LinkButton>&nbsp;&nbsp;
                    ...
                    <telerik:RadGrid
                        ...
                        <MasterTableView>
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" UniqueName="Clen"
                                    HeaderText="" Visible="true">
                                    <ItemTemplate> 
                                        <asp:LinkButton ID="ImgClean" runat="server" CommandName="Clean" OnClientClick="javascript:return confirm('Clean Data?')" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID") %>'>
        <span class="btn-ico material-symbols-outlined" title="Clean" ToolTip="Clean">mop</span>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="Name" UniqueName="Name" HeaderText="Name"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="Total" UniqueName="Total" HeaderText="Total"></telerik:GridBoundColumn>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group"  disabled="disabled">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="TxtId"  MaxLenght="255" DataField="ID" runat="server"   Enabled="false" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="TxtName" MaxLenght="255" DataField="NAME" runat="server" Required="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="Txt1" MaxLenght="255" DataField="TOTAL" runat="server" Required="true" />
                                                </div>
                                            </div>
