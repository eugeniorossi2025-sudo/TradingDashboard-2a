<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MasterFirst.master" AutoEventWireup="false"
    CodeFile="Configurations.aspx.vb" Inherits="Configurations" Trace="false" %>
                        ...
                        <MasterTableView>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" UniqueName="Edit"
                                    HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="ImgOpen" runat="server" CommandName="Open" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.K") %>'>
                                ...
                                <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="30" UniqueName="Delete"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="ImgDelete" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Delete record?')" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.K") %>'>
                                        <span class="btn-ico material-symbols-outlined" title="delete" ToolTip="Delete">delete</span>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="K" UniqueName="Key" HeaderText="Key"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="Description" UniqueName="Description" HeaderText="Description"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="Value" UniqueName="Value" HeaderText="Value"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="false" FilterControlAltText="Filter ContactName column" DataField="Pos" UniqueName="Pos" HeaderText="Pos"></telerik:GridBoundColumn>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="TxtId" MaxLenght="255" DataField="K" runat="server" Required="true" Enabled="false" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="TxtValue" MaxLenght="255" DataField="Value" runat="server" Required="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <DtControl:Txt ID="Txt1" MaxLenght="255" DataField="Pos" runat="server" Required="true" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <div runat="server" id="Div_Terminated" class="alert alert-success alert-dismissible fade in" role="alert">
                                                        <span class="btn-ico material-symbols-outlined">task_alt</span> <span>Saved successfully!</span>
                                                    </div>
