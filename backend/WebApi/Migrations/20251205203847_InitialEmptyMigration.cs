    ...
    public partial class InitialEmptyMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PC = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commands_Users_ID_User",
                        column: x => x.ID_User,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Grid_Configurations_Users_ID_user",
                        column: x => x.ID_user,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TAVOLO = table.Column<int>(type: "int", nullable: true),
                    MAZZO = table.Column<int>(type: "int", nullable: true),
                    MARGINE = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: true),
                    MEDIA_ORA = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: true),
                    STATO = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    COLORE = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    COLPO_MARTINGALA = table.Column<int>(type: "int", nullable: true),
                    VALUTAZIONE = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    REASON = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PREDICTION = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PBT = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    TEMPO = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Values", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Values_Users_Id_User",
                        column: x => x.Id_User,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Values_ACCOUNT_TAVOLO",
                table: "Values",
                columns: new[] { "ACCOUNT", "TAVOLO" });
