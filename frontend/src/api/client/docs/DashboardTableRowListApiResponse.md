# DashboardTableRowListApiResponse
...
**data** | [**Array&lt;DashboardTableRow&gt;**](DashboardTableRow.md) | Gets or sets the data payload. | [optional] [default to undefined]
...
```typescript
import { DashboardTableRowListApiResponse } from './api';

const instance: DashboardTableRowListApiResponse = {
    success,
    message,
    data,
    errors,
