...
**data** | [**Array&lt;ChartDataPoint&gt;**](ChartDataPoint.md) | Gets or sets the data payload. | [optional] [default to undefined]
...
```typescript
import { ChartDataPointListApiResponse } from './api';

const instance: ChartDataPointListApiResponse = {
    success,
    message,
    data,
    errors,
