...
**data** | [**Array&lt;Device&gt;**](Device.md) | Gets or sets the data payload. | [optional] [default to undefined]
...
```typescript
import { DeviceIEnumerableApiResponse } from './api';

const instance: DeviceIEnumerableApiResponse = {
    success,
    message,
    data,
    errors,
