...
**data** | [**Array&lt;User&gt;**](User.md) | Gets or sets the data payload. | [optional] [default to undefined]
...
```typescript
import { UserIEnumerableApiResponse } from './api';

const instance: UserIEnumerableApiResponse = {
    success,
    message,
    data,
    errors,
