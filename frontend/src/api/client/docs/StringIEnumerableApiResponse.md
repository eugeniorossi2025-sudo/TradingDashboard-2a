...
**data** | **Array&lt;string&gt;** | Gets or sets the data payload. | [optional] [default to undefined]
...
```typescript
import { StringIEnumerableApiResponse } from './api';

const instance: StringIEnumerableApiResponse = {
    success,
    message,
    data,
    errors,
