...
**data** | [**DashboardResponse**](DashboardResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { DashboardResponseApiResponse } from './api';

const instance: DashboardResponseApiResponse = {
    success,
    message,
    data,
    errors,
