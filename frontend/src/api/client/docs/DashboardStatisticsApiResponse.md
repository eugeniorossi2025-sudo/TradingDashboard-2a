...
**data** | [**DashboardStatistics**](DashboardStatistics.md) |  | [optional] [default to undefined]
...
```typescript
import { DashboardStatisticsApiResponse } from './api';

const instance: DashboardStatisticsApiResponse = {
    success,
    message,
    data,
    errors,
